...
export default function AdminPanel() {
  ...
  const presets = [
    ...
    },
    {
      ...
      subtitle: 'Review Round 1 is active! Prepare your architecture diagrams, codebase, and live demo.',
      type: 'review',
      theme: 'purple',
      durationMinutes: 60,
      icon: CheckCircle2,
    ...
    {
      id: 'interval',
      title: 'INTERVAL BREAK',
      subtitle: 'Take a breather, stretch your legs, and align next sprint goals with your team.',
      type: 'interval',
      theme: 'amber',
      durationMinutes: 30,
      icon: Film,
